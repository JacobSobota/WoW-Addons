...
RUI.InstallerData = {
	Title = format("|cffc41f3b%s %s|r", RUI.PluginName, "Installation"),
	Name = RUI.PluginName,
	...
	Pages = {
		[1] = function() --Welcome
			if E.db[RUI.PluginName].install_version == nil and E["global"][RUI.PluginName].profile_name then
			...
			elseif E.db[RUI.PluginName].install_version == RUI.Version or E.db[RUI.PluginName].install_version == nil then
      ...
      PluginInstallFrame.Desc3:SetText(MissingAddons)
		...
		[2] = function() --Profile Setup
			if E.db[RUI.PluginName].install_version == nil or E.db[RUI.PluginName].install_version == RUI.Version then
				...
				PluginInstallFrame.Desc3:SetText("Your currently active ElvUI profile is: |cffc41f3b" .. E.data:GetCurrentProfile() .. "|r")
				PluginInstallFrame.Option1:Show()
		...
		[3] = function() --Layout
			...
			if not (E.db[RUI.PluginName].layout == "Aldarana" or E.db[RUI.PluginName].layout == "Redtuzk") then
				E.db[RUI.PluginName].layout = nil
			end
			if E.db[RUI.PluginName].install_version == nil or E.db[RUI.PluginName].install_version == RUI.Version or not E.db[RUI.PluginName].layout then
				...
				PluginInstallFrame.Option2:Show()
				PluginInstallFrame.Option2:SetScript("OnClick", function() RUI:SetupLayout("Aldarana") end)
				...
				PluginInstallFrame.Option1:Show()
				PluginInstallFrame.Option1:SetScript("OnClick", function() RUI:SetupLayout(E.db[RUI.PluginName].layout) end)
				PluginInstallFrame.Option1:SetText("Update Layout")
			end
		end,
		[4] = function() --NamePlates
			if (E.db[RUI.PluginName].layout == "Redtuzk" or E.db[RUI.PluginName].layout == "Aldarana") and IsAddOnLoaded("Plater") then
		    PluginInstallFrame.SubTitle:SetText("NamePlates")
				...
				E.db[RUI.PluginName]["plater"] = false
			end
		end,
		...
		-- [5] = function() --Boss Mod
		-- 	if IsAddOnLoaded("BigWigs") and (E.db[RUI.PluginName].layout == "Redtuzk" or E.db[RUI.PluginName].layout == "Aldarana") then --Make sure the User has BigWigs installed.
		...
		[6] = function() -- Install Complete
			...
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:SetScript("OnClick", RUI.CreateDiscordLink)
